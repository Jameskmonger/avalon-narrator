...
/***/ "./node_modules/avalon-prompts/index.js":
/*!**********************************************!*\
  !*** ./node_modules/avalon-prompts/index.js ***!
  \**********************************************/
...
var getAgentsOfEvilPhase = function (characters) {
    return [
...
var getMerlinPhaseIntroduction = function (characters) {
...
var getMerlinPhase = function (characters) {
    var introduction = getMerlinPhaseIntroduction(characters);
    return [
...
var getPercivalPhase = function (characters) {
    if (!characters.percival) {
        return [];
    }
    var target = characters.morgana ? "Merlin and Morgana" : "Merlin";
    return [
...
exports.getPrompts = function (characters) {
    if (characters === void 0) { characters = {}; }
    var chars = __assign({}, defaultCharacters, characters);
    var prompts = [
        "All players: close your eyes and extend your hand into a fist infront of you"
    ].concat(getAgentsOfEvilPhase(chars), getMerlinPhase(chars), getPercivalPhase(chars), [
